//
//  TriggerListTableViewController.h
//  WRAssistant
//
...
@interface TriggerListTableViewController : UITableViewController <NSFetchedResultsControllerDelegate>
...
@property (nonatomic, readonly) NSArray *triggerGroups;
